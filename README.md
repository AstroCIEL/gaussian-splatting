...
### `diff-gaussian-rasterization` patch

in `submodules/diff-gaussian-rasterization/cuda_rasterizer/rasterizer_impl.h` header add `#include <cstdint>`
...
```shell
# SSH
git clone git@github.com:AstroCIEL/gaussian-splatting.git --recursive
```
or
```shell
# HTTPS
git clone https://github.com/AstroCIEL/gaussian-splatting --recursive
```
